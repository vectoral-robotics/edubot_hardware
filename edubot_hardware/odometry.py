...
Compatible with the ESP32-based motor controller using encoder format:
    E seq time t_rr t_fr t_rl t_fl
"""
...
class OdometryEstimator:
    ...
    def __init__(self,
        ...
        # Expected order (ESP32): (t_rr, t_fr, t_rl, t_fl)
    ...
    def update(self,
        ...
        Args:
            ticks: tuple (t_rr, t_fr, t_rl, t_fl)
        ...
        t_rr, t_fr, t_rl, t_fl = ticks
        l_rr, l_fr, l_rl, l_fl = self._last_ticks
        self._last_ticks = ticks
        ...
        # If encoder polarity is already correct, keep as-is
        # (Remove sign flips unless you see reversed motion.)
        ...
        self._wheel_angles[0] += (d_rr / self.ticks_per_rev) * two_pi
        self._wheel_angles[1] += (d_fr / self.ticks_per_rev) * two_pi
        self._wheel_angles[2] += (d_rl / self.ticks_per_rev) * two_pi
        self._wheel_angles[3] += (d_fl / self.ticks_per_rev) * two_pi
